...
specialRvisi specialRvisiInstance = new specialRvisi();
...
if (selectedDate != null && selectedDate1 != null) {
    ...
    specialRvisiInstance.jTextField1.setText(checkInDateString);  // check-in date
    specialRvisiInstance.jTextField2.setText(checkOutDateString); // check-out date
    ...
    try {
        ...
        specialRvisiInstance.jTextField3.setText("75,000 * "+String.valueOf(diff)+" Days"+ "=" +50000*(diff));  // Display days difference in sweetCpriInstance
...
if (selectedDate != null && selectedDate1 != null) {
   specialRvisiInstance.setVisible(true);
}
