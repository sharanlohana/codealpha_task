...
sweetRvisi sweetRvisiInstance = new sweetRvisi();
...
if (selectedDate != null && selectedDate1 != null) {
    ...
    sweetRvisiInstance.jTextField1.setText(checkInDateString);  // check-in date
    sweetRvisiInstance.jTextField2.setText(checkOutDateString); // check-out date
    ...
    try {
        ...
        sweetRvisiInstance.jTextField3.setText("75,000 * "+String.valueOf(diff)+" Days"+ "=" +75000*(diff));  // Display days difference in sweetCpriInstance
...
if (selectedDate != null && selectedDate1 != null) {
    sweetRvisiInstance.setVisible(true);
}
